...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Answer incorrect. Correct answer is ${calculatedAnswer[0]}`)
...
/**
 * Gets the operands (numbers) and the operator directly from 
...
/**
 * Gets the current count of incorrect answers
